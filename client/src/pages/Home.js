...
import LearningLanguageSection from "../components/core/HomePage/LearrningLanguageSection";
    ...
    <div>
      <div className='mx-auto relative flex flex-col w-11/12 items-center justify-between text-white'>
            <Link onClick={()=>{dispatch(setProgress(100))}}  to={"/signup"}>
                <div className=' group mt-16 p-1 mx-auto rounded-full bg-richblack-600 font-bold transition-all duration-200 hover: scale-95    w-fit max-w-maxContent'>
            ...
            <div className="mx-3 my-7 mt-16 shadow-[10px_-5px_50px_-5px] shadow-yellow-600">
                <video
