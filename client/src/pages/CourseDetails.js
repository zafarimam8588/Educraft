...
const CourseDetails = () => {
  ...
  return (
    <div>
      <div className=" mx-4 lg:mx-20 px-4   ">
        <div className=" py-8  lg:mx-0  lg:py-0  ">
          {/* THIS BLOCK WILL ONLY BE VISIBLE IN SMALLER SCREEN */}
          ...
          <div className=" my-20  py-5 text-lg text-richblack-5">
            <div className="w-[700px]  text-4xl font-bold text-richblack-5 sm:text-[42px] mb-5">
              {courseDetail?.courseName}
            </div>
            <div className="w-[700px] text-richblack-200  my-4 ">
              {courseDetail?.courseDescription}
            </div>
            <div className="flex gap-x-3 items-center">
              <span className="text-yellow-50 my-2">{avgReviewCount || 0}</span>
              <RatingStars Review_Count={avgReviewCount} />
              <span className="md:block hidden md:text-xl text-richblack-5 my-2">
                ({courseDetail?.ratingAndReviews?.length} Reviews)
              </span>
              <span className="text-richblack-200 my-2">
          ...
          <p className="my-2">
            ...
            <div className="flex flex-wrap gap-5 text-lg my-2">
          ...
          {/* BOTH BUTTONS IN SMALLER SCREEN */}
            ...
            {ACCOUNT_TYPE.INSTRUCTOR !== user?.accountType && (
              <>
                {alreadyEnrolled ? (
                  ...
                  <button onClick={handelPayment} className="yellowButton text-richblack-5">
                    Buy Now
                  </button>
                )}
                {alreadyEnrolled ? (
        ...
        {/* THIS BLOCK IS ONLY VISIBLE IN LARGE */}
        <div className="right-[50px] top-[100px] mx-auto hidden min-h-[600px] w-1/3 max-w-[410px] translate-y-24 md:translate-y-0 lg:absolute  lg:block">
