...
router.post("/editCourse", auth, isDemo, isInstructor, editCourse);

router.post("/addSection", auth, isInstructor, createSection);
router.post("/updateSection", auth, isInstructor, updateSection);
router.post("/deleteSection", auth, isDemo, isInstructor, deleteSection);
...
// RATING ROUTES
router.post("/createRating", auth, isDemo, isStudent, createRating);
