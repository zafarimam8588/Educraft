...
const CourseBuilderForm = () => {
  ...
  return (
    <div className="text-richblack-5 space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6">
      ...
      {/* THIS WILL SHOW THE INFORMATION ABOUT SECTION AND SUBSECTION  */}
