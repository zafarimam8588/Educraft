...
const CourseInformationForm = () => {
  ...
  const onSubmit = async (data) => {
    if (editCourse) {
      ...
      return; // IF THIS WILL HAPPEN THEN JUST COME OUT OF FUNCTION
    }
  ...
  return (
    <form
      ...
      className="text-white space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6"
    >
      ...
      <div className="relative flex flex-col space-y-2">
        ...
        <input
          ...
          {...register("coursePrice", {
            required: true,
            valueAsNumber: true, // FOR NUMERIC VALUE
          })}
